        ...
        case "2":
            ...
            while (userChoice == "")
            {
                ...
                if (readResult != null)
                {
                    ...
                    {
                        dogCharacteristics = userChoice.Split(',');
                    }
                    else
                    {
                        dogCharacteristics = new string[1];
                        dogCharacteristics[0] = userChoice;
                    }
                    Console.WriteLine();
                }
            }
            ...
            for (int i = 0; i < maxPets; i++)
            {
                if (ourAnimals[i, 1].Contains("dog"))
                {
                    foreach (string characteristic in dogCharacteristics)
                    {
                        if (ourAnimals[i, 1].Contains("dog"))
                        {
                            if(ourAnimals[i,4].Contains(characteristic))
                            {
